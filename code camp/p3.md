Om has a string S of length N. But Om being perfectionist, doesn't likes the string. He deciedes to do perform M operations on the string to see if final string generated is perfect or not.
